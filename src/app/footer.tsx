            ...
            <ColoredLine color="rgba(256,256,256,0.5)"  />
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '20px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', marginRight: '10px', marginLeft: '10px' }}>
                        ...
                        <p>General Setup Instructions</p>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', marginRight: '10px', marginLeft: '10px' }}>
                        ...
                        <p>$FRY Recycle Mining</p>
                        <p>Free Tier Instructions</p>
                        <p>Paid Tier Instructions</p>
                        <p>Free Tier Registration</p>
                        <p>Paid Tier Registration</p>
                        <p>Paid Tier Plans</p>
                        {/* Add the rest of your links here */}
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'column', marginRight: '10px', marginLeft: '10px' }}>
