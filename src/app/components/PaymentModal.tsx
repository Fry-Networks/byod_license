        ...
        >
            ...
            <p style={{ textAlign: 'center' }}>
               ...
               style={{color: 'red', fontSize: '20px'}}
                >It is HIGHLY recommended to browse this website using a computer, as mobile devices are known to have issues with the transaction system we're using (the responsible team is working on it)</strong>
            </p>
