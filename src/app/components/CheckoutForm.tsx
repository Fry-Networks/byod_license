...
import { createPaymentIntent, handlePaymentIntent } from '../classes/Stripe'; // make sure to change this to your actual file location
...
function CheckoutForm({ email, payment }: {
    ...
    const handleSubmit = async (event: any) => {
        ...
        const handledData = await handlePaymentIntent(email, paymentIntent)
        payment.setData((currentData: any) => ({ ...currentData, stripe: handledData }));
